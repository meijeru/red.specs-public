...
This is possible both for values that are _sequences_ (with types in `series!`,
...
|vector!    |integer! logic!^1^ |pick poke   |integer! char!                      |select^2^
|string!    |integer! logic!^1^ |pick poke   |char! any-string! binary!           |select^2^
|email!     |integer! logic!^1^ |pick poke   |char! any-string! binary! host user |select^2^
|file! url! |integer! logic!^1^ |pick poke   |char! any-string! binary!           |select^2^
|binary!    |integer! logic!^1^ |pick poke   |integer! char! any-string! binary!  |select^2^
