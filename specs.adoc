...
During initialization of the toolchain, a dispatch table (_action table_) is
prepared that contains entries for each combination of action and type of first argument 
...
. Determine the `<argument-spec>` of the action.
...
. Call the Red/System function that handles the action (its name is the action name followed by `*`)
...
+ - * / // %             2          number! time! char! pair! tuple! vector!
**                       2          number!
NaN?                     1          number!                                    logic!
sign?                    1          number! time!                              integer!
positive? negative?      1          number! time!                              logic!
zero?                    1          number! time! char! pair! tuple!           logic!
