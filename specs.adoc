...
a single-digit number, `<minutes>` must have 2 digits here _**why**_; `<hhmm>` stands for
...
(1 = Monday _**check**_) and the `yearday` component is the ordinal number of the date in the
