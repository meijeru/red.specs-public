...
|`NaN?`                |1       |`number!`             |                  |`logic!`
|`sign?`               |1       |`money! number! time!`|                  |`integer!`^2^
...
|`negate`              |1       |`money! number! time! pair!`|            |same as operand^3^
|`absolute round`      |1       |`money! number! time! pair!`|            |same as operand^3^
...
|`average`             |1       |`any-list!`^4^ `vector!` |               |see note^5^
|===
...
. components must be of type `money!`, `number!`, `char!`, `time!`, `pair!` or `tuple!`
