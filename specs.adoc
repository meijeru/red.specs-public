...
somehow "store" any values. We say that a word is _bound to a value_ in some
_context_, i.e. evaluating the word in that context yields the value.

All word values have two important properties in this regard: their identity,
i.e their spelling (disregarding upper- or lowercase), and the context they
are bound to.
