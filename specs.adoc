...
in section _**Evaluation rules**_. As evident from rule `S101`, evaluation of the operands of
operators has precedence over function application; also, operators are strictly _left associative_,
