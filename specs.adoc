...
. Values of all types may be represented using `make`, except those of `datatype! native! action! routine!` and `event!`
. _**See REP #14**_
. _**See REP #12**_
....
TBD
...
values of type `datatype! native! action!` and `event!` may not be made using `make`.
...
(see the beginning of section <<creation-of-values-code-make-code,5.3>>). _**See REP #13**_
...
6.3.6>>). The bound block is then _executed_. _**See issue #3362**_
...
<<type-hierarchy,section 4.3>>). User-defined typesets may not be mentioned. _**See issue #3285**_
...
type specified, `any-type!` is assumed._**see issue #2766**_ The `<type-name>`
must be `integer! float!` or `logic!`, or one that has a Red/System `struct!`
alias defined that describes a value slot of that type._**see issue #2642**_
...
of `bitset!` values are indexed from `0`. Additionally, for programming convenience,
values of `series!` types may be indexed by `logic!` values, where `true` yields
the first component and `false` the second component.
Also, bitsets admit indexing by characters and strings, with the result being `true`
if the component(s) with the corresponding Unicode Code Point number(s) are (all)
`true`. Finally, images may also be indexed by pairs as coordinates, with the index
...
....
Here `<source>` and `<destination>` must be a `<word-literal>` or a `<path-literal>`.
Note that for lexical reasons, a `char!`, `string!` or `pair!` value used as index
in path expressions must be enclosed in parentheses. Furthermore, `logic!` values are not allowed.
...
which should be a single value of allowable type for `find`, or a sequence of such values,
and the result is the component *after* the first occurrence of the key (single or sequence)
if found, and `none` otherwise.
* For the other types, which contain key/value pairs, the result is the value
corresponding to the given key. In these cases, it is customary to call the keys _fields_.
...
....
The same lexical restrictions apply as noted above for indexing.
...
These are explained in <<contexts,section 6.2>>. _**See REP #14**_. 
...
_**Functions on vector! values have been requested see REP #12**_
...
|negate              |1       |number! time! pair! |                |same as operand^1^
|absolute round      |1       |number! time! pair! |                |same as operand^1^
...
|tuple!       |          |tuple!^1^ |tuple!^1^ |tuple!^1^|         |         |          |tuple!^1^ |
...
<a href= "https://github.com/red/red/issues/1957">1957</a>   <a href="#">5.7</a>
<a href= "https://github.com/red/red/issues/1960">1960</a>   <a href="#">5.6.3</a>
<a href= "https://github.com/red/red/issues/1961">1961</a>   <a href="#">9.3</a>
<a href= "https://github.com/red/red/issues/2216">2216</a>   <a href="#">8.1</a>
<a href= "https://github.com/red/red/issues/2492">2492</a>   <a href="#">3.1</a>
<a href= "https://github.com/red/red/issues/2554">2554</a>   <a href="#">5.6.2</a>
<a href= "https://github.com/red/red/issues/2565">2565</a>   <a href="#">4.3</a>
<a href= "https://github.com/red/red/issues/2577">2577</a>   <a href="#">5.3.11</a>
<a href= "https://github.com/red/red/issues/2578">2578</a>   <a href="#">7.3.5</a>
<a href= "https://github.com/red/red/issues/2589">2589</a>   <a href="#">5.3.8</a>
<a href= "https://github.com/red/red/issues/2609">2609</a>   <a href="#">5.3.5</a>
<a href= "https://github.com/red/red/issues/2622">2622</a>   <a href="#">7.4.1</a>
<a href= "https://github.com/red/red/issues/2625">2625</a>   <a href="#">5.6.2</a>
<a href= "https://github.com/red/red/issues/2633">2633</a>   <a href="#">5.8.1</a>, <a href="#">12.1</a>
<a href= "https://github.com/red/red/issues/2642">2642</a>   <a href="#">5.3.9</a>
<a href= "https://github.com/red/red/issues/2645">2645</a>   <a href="#">5.4.2</a>
<a href= "https://github.com/red/red/issues/2650">2650</a>   <a href="#">5.8.1</a>
<a href= "https://github.com/red/red/issues/2657">2657</a>   <a href="#">5.8.1</a>
<a href= "https://github.com/red/red/issues/2658">2658</a>   <a href="#">5.8.1</a>
<a href= "https://github.com/red/red/issues/2662">2662</a>   <a href="#">5.8.2</a>
<a href= "https://github.com/red/red/issues/2668">2668</a>   <a href="#">11.1</a>
<a href= "https://github.com/red/red/issues/2776">2776</a>   <a href="#">8.1</a>
<a href= "https://github.com/red/red/issues/2883">2883</a>   <a href="#">5.6.2</a>
<a href= "https://github.com/red/red/issues/3174">3174</a>   <a href="#">7.4.1</a>
<a href= "https://github.com/red/red/issues/3285">3285</a>   <a href="#">5.3.8</a>
<a href= "https://github.com/red/red/issues/3362">3362</a>   <a href="#">5.3.6</a>
<a href= "https://github.com/red/red/issues/3379">3379</a>   <a href="#">9.3</a>
<a href= "https://github.com/red/red/issues/3395">3395</a>   <a href="#">8.1</a>
<a href= "https://github.com/red/red/issues/3409">3409</a>   <a href="#">5.4.3</a>, <a href="#">11.1</a>
<a href= "https://github.com/red/red/issues/3423">3423</a>   <a href="#indexing">5.6.1</a>

REP    spec
issue  section

 <a href="https://github.com/red/REP/issues/9"> 9</a>    <a href="#">3.2</a>
 <a href="https://github.com/red/REP/issues/10">10</a>    <a href="#">8.1</a>, <a href="#">8.4</a>
 <a href="https://github.com/red/REP/issues/11">11</a>    <a href="#">11.7</a>
 <a href="https://github.com/red/REP/issues/12">12</a>    <a href="#">5.7</a>
 <a href="https://github.com/red/REP/issues/13">13</a>    <a href="#">5.3.3</a>
 <a href="https://github.com/red/REP/issues/14">14</a>    <a href="#">5.7</a>
</pre>
++++
