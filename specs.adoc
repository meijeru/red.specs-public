...
or "null" in other languages). Th complete list, which is considerably
...
The function `rejoin` will `reduce` and then `form` all elements of its `block!` argument
and concatenate them into a `string!` result.
