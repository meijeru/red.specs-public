...
|`+ - * / // %`        |2     |`integer! float!`     |`char!`           |`char!`
|`+ - * / // %`        |2     |`number!`             |`number!`         |see table below
|`+ - * / // %`        |2     |`vector!`             |`number!`         |`vector!`^1^
|`+ - * / // %`        |2     |`number`              |`vector!`         |`vector!`^1^
|`+ - * / // %`        |2     |`vector!`             |`vector!`         |`vector!`^2^
|`+ - * / // %`        |2     |`money!`              |`integer! float!` |`money!`
|`+ - * / // %`        |2     |`integer! float!`     |`money!`          |`money!`
|`+ - * / // %`        |2     |`money! `             |`money!`          |`money!`^3^
|`+ - * / // %`        |2     |`number!`             |`time! pair! tuple!` |same as operand 2
|`+ - * / // %`        |2     |`time! pair! tuple!`  |`number!`         |same as operand 1
|`+ - * / // %`        |2     |`integer!`            |`date!`           |`date!`
|`+ - * / // %`        |2     |`date!`               |`integer!`        |`date!`
|`+ - * / // %`        |2     |`date!`               |`date!`           |`integer!`
|`+ - * / // %`        |2     |`time!`               |`time!`           |see note ^4^
|`+ - * / // %`        |2     |`date!`               |`time!`           |`date!`
|`+ - * / // %`        |2     |`time!`               |`date!!`          |`date!`
|`+ - * / // %`        |2     |`pair!`               |`pair!`           |`pair!`
|`+ - * / // %`        |2     |`tuple!`              |`tuple!`          |`tuple!`
|`**`                  |2     |`number!`             |`integer! float!` |`integer!`^5^ `float!`
|`NaN?`                |1     |`number!`             |                  |`logic!`
|`sign?`               |1     |`money! number! time!`|                  |`integer!`^6^
...
|`negate`              |1     |`money! number! time! pair!`|            |same as operand^7^
|`absolute round`      |1     |`money! number! time! pair!`|            |same as operand^7^
|`max min`             |2     |`scalar!`             |`scalar!`         |same as greatest/smallest operand +
(operand 1 if equal)
|`sum`                 |1     |`any-list!`^8^ `vector!` |               |same as individual numbers +
(refer to table below if not all numbers have the same type)
|`average`             |1       |`any-list!`^8^ `vector!` |               |see note^9^
|===
...
. if both operand 1 and 2 have the currency indicated, they must be the same
...
|===
|operand&nbsp;2 -> +
operand&nbsp;1 |number!     |money!  |time!    |date!    |pair!    |tuple!     |vector!
|integer!      |float!^13^  |money!^1^ |time!  |date!^9^ |pair!^1,2^ |tuple!^1,2,3^ |vector!^1,6^
|float!        |float!      |money!^1^ |time!  |         |pair!^1,2^ |tuple!^1,2,3^ |vector!^1,6^
