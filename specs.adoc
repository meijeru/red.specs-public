...
the series value slot to point to the changed series:
`reverse sort random clear remove take change replace alter trim pad insert append repend swap move`
