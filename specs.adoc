...
rules for conversion by `to`; refer to the <<conversion-of-values-to,next section>>
...
mentioned through notes 1 to 13. The operations on values of type `pair! tuple!` and `vector!`
