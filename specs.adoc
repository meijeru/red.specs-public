...
**TBD: CLEAN UP
In the case of non-immdiate values, more than one word can refer to the same
...
associated context of the word. Asking for the global context yields the object
`system/words`.
