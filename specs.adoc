...
=== Expressions and valuation order
...
to a prefix function (value of type `action! native! function!` or `routine!`).

TBD: change this

The values of a Red programs are in principle evaluated from left to right, according
...
(see rule `E110` in section _**Function types**_), and evaluation of the arguments of
...
skip <series> <value>    current index + <value>
