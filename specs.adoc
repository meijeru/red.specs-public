...
(6) result has element type of operand 1 see also issue #2216
...
dialect                                 2.5
  ...
  compose dialect                       2.5
  draw dialect                          2.5
  error spec dialect                    2.5
  function spec dialect                 2.5
  image spec dialect                    2.5
  map spec dialect                      2.5
  object spec dialect                   2.5
  parse dialect                         2.5
  preprocessor dialect                  2.5
  routine spec dialect                  2.5
  shape dialect                         2.5
  system dialect                        2.5
  vector spec dialect                   2.5
  Visual Interface dialect (VID)        2.5
direct type                             4.2.2
