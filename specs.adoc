...
need not be a valid Unicode Codepoint number. _**See https://github.com/red/red/issues/3439[issue #3439]**_
...
_**See <a href= "https://github.com/red/red/issues/3450">issue #3450</a>**_
...
where `0` and `none` set the bit to `false`, and all other values set the bit to `true`.
...
<a href= "https://github.com/red/red/issues/3439">3439</a>   <a href="#code-bitset-code">5.3.5</a>
<a href= "https://github.com/red/red/issues/3450">3450</a>   <a href="#target-type-code-char-code">5.4.7</a>
