...
the _function spec dialect_, the _object spec dialect_, the _bitset spec dialect_,
the _vector spec dialect_,
the _parse dialect_, the _view dialect_, the _draw dialect_ which includes
a _shape dialect_ and more.
...
type or such a value is supplied as argument to a function, this value may
