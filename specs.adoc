...
Otherwise, `default!` will be assumed. Likewise, when present, the type(set)s of the `<return-spec>`
...
Note that selecting a component which is a value of type `any-function` by means of a
...
<a href= "https://github.com/red/red/issues/3482">3482</a>   <a href="#indexing">5.6.1</a>
