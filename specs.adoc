...
The following operations on bitsets have been described in section 8.3: `intersect union difference exclude`,
and 8.4: `complement and or xor`. Series-like operations defined on bitsets are: `append clear copy find
insert length? pick poke remove`.

=== Operations on maps

Series-like operations defined maps are: `clear copy find put select`.
