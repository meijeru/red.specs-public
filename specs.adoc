...
using grammar rules. It is an enhanced member of the TDPL family.
...
=== Red/View component, GUI System

The Red/View (or just View) component is a graphic system for the Red programming language.
...
The virtual tree is built using _face objects_. Each face object maps to a graphic component
on the display in a two-way binding.
