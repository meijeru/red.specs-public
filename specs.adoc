...
* `exists-thru?` operates the same with respect to the _thru-cache_ (see section 11.6)  
...
system/   object!
    ...
    options/    object!             
        ...
        thru-cache     file!         see section 11.6
        args           
        do-arg         
        debug          logic!
        secure         
...
direct type                             4.2.2
disk-cached remote file access          11.6
...
remote file access (disk-cached)        11.6
