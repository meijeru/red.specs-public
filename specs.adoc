...
|===
|operand&nbsp;2 -> +
operand&nbsp;1 |char!    |number!  |time!    |date!    |pair!    |tuple!     |vector!
|char!        |char!^1^  |char!^1,12^  |         |         |         |           |vector!^1,6^
|integer!     |integer!^1^ |float!^13^   |time!    |date!^9^ |pair!^1,2^ |tuple!^1,2,3^ |vector!^1,6^
|float!       |float!^1^ |float!    |time!    |         |pair!    |tuple!     |vector!
