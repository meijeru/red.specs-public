...
<hexidecimal-codepoint> :: = "^(<hexidecimal-byte> | <hexidecimal-byte><hexidecimal-byte>)| 
                            <hexidecimal-byte><hexidecimal-byte><hexidecimal-byte> | 
                            <hexidecimal-byte><hexidecimal-byte><hexidecimal-byte><hexidecimal-byte>"

<hexidecimal-byte> :: = 0-F0-F
