...
with a limited number of allowed values.
...
* `email!` values: the ùser` and `host` component values should be supplied as strings
...
mentioned through notes (1) to (9). The operations on values of type `pair! tuple!` and `vector!`
...
time!                 time!    time!    time!    time!    date!                        vector!
                                                 (4)(5)   (9)                          (1)(6)
