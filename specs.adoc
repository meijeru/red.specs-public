...
because the latter has a discrete number of values it is tightly encoded.
...
with overflow resulting in increasing the date. Note that it represents _local time_.
