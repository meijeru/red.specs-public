...
|`hex!`           |strings of hexadecimal characters, to be used for identification purposes or as hexadecimal encoding of a large positive number
...
upper limit to the number of such characters. The value of the `<hex-literal>` is the string of hexadecimal
characters.
