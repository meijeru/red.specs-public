...
with a `<spec>` which is a non-negative `integer!` or `float!` value: the `float!` value
...
|`file!`           |basic I/O            |`read` `write` `query` `delete` `modify` `rename`
...
. Red Programming Language Documentation (Gitbook), notably:
  .. https://github.com/red/docs/blob/master/en/SUMMARY.adoc[Red Core Language]
  .. https://github.com/red/docs/blob/master/en/gui.adoc[GUI System]
  .. https://github.com/red/docs/blob/master/en/parse.adoc[Parse]
  .. https://github.com/red/docs/blob/master/en/lexer.adoc[Lexer]
  .. https://github.com/red/docs/blob/master/en/reactivity.adoc[Reactive Programming]
  .. https://github.com/red/docs/blob/master/en/preprocessor.adocl[Preprocessor]
