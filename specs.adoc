...
_Ports_ represent persistent resources in the most general sense, both external
(including, but not restricted, to files and urls) and internal (e.g. in-process
channels and aggregators). As a generalization of files and urls, they implement
