...
|===
|operand 1 &2193 ; 2 -> |char!|integer!|float! |percent! |time!    |date!    |pair!    |tuple!     |vector!
...
. only add allowed
. only subtract allowed; result is number of days; for exact difference use built-in function difference
