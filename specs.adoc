...
functions are as follows.  If an artihmetic operator is not mentioned, it is not allowed
...
|`+ -         `        |2     |`date!`               |`time!`            |`date!`
|`+           `        |2     |`time!`               |`date!`            |`date!`
|`+ -   / // %`        |2     |`time!`               |`time!`            |see note ^5^
|`+ - * / // %`        |2     |`pair!`               |`pair!`            |`pair!`
|`+ - * / // %`        |2     |`tuple!`              |`tuple!`           |`tuple!`
|`**`                  |2     |`number!`             |`integer! float!`  |`integer!`6^ `float!`
...
|`NaN?`                |1     |`number!`                                |`logic!`
|`sign?`               |1     |`money! number! time!`                   |`integer!`^7^
...
|`negate`              |1     |`money! number! time! pair!`             |same as operand^8^
|`absolute round`      |1     |`money! number! time! pair!`             |same as operand^8^
|`sum`                 |1     |`any-list!`^9 `vector!`                 |same as individual numbers +
(refer to table below if not all numbers have the same type)
|`average`             |1       |`any-list!`^9^ `vector!`               |see note^10^
|===
