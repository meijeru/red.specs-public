...
the argument to `/as` is `json`. The correpsonding object in `system/codecs` is
[cols="1,1,2", options="header"]
|===
    |key             |value type   |content
    ...
    |suffixes        |block!       |[%.json]
    |encode          |func!        |func [data [any-type!] where [file! url! none!]][...]
    |decode          |func!        |func [data [any-type!]][...]
|===
