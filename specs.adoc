...
there is no decimal fraction -- then it is of type ìnteger!`;
also, if the first operand type is of type `percent!`, the result is of type `percent!` 
. the result is truncated to the nearest integer
...
<a href= "https://github.com/red/red/issues/3910">3910</a>  N <a href="#repeated-execution-loops">10.2</a>
