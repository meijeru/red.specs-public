...
Note that the `help` built-in function is typically making good use of thesefacilities. 
...
issue  section
 ...
 <a href="https://github.com/red/REP/issues/14">14</a>    <a href="#overview-table">4.2.7</a>, <a href="#enquiry-and-reflection-on-values">5.7</a>
