...
.. If the type is in `any-function!` _apply_ the function (see rules <<code-function-code-type,`E110-114`>>).
...
(see <<conversion-from-to_textual-representation,section 11.1>>)
